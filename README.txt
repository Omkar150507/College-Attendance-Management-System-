...
----------------------
The project uses the standard Flask `templates/` and `static/` directories. Static assets are under `static/images/`, including `college_logo.png` and `login-campus-bg.jpg`.
